...
**Your voice**: `bf_alice`
**Rationale**: Precise, British — frozen research project
...
1. Add a `## Voice Identity` section to your project's CLAUDE.md:
   ...
   **Use**: every cycle-complete, every P0/P1 completion, every directive response.
   ```
2. Update your `cos-speak` wrapper (or equivalent) to default to `bf_alice` on your surfaces.
...
4. Sample call:
   ...
   curl -sS -X POST http://100.123.83.34:8880/v1/audio/speech \
     ...
     -d '{"model":"kokoro","input":"Your message here.","voice":"bf_alice","response_format":"wav"}' \
...
### Reflection — 2026-03-15 (Check-in 131)

No new code. `git diff HEAD origin/main` empty. All TQs resolved. No active directives. Tests: **893 / 29 files**. _(TQ-008 one-liner authorized.)_

### Reflection — 2026-03-15 (Check-in 132)

No new code. `git diff HEAD origin/main` empty. All TQs resolved. No active directives. Tests: **893 / 29 files**. _(TQ-008 one-liner authorized.)_

### Reflection — 2026-03-15 (Check-in 133)

No new code. `git diff HEAD origin/main` empty. All TQs resolved. No active directives. Tests: **893 / 29 files**. _(TQ-008 one-liner authorized.)_

### Reflection — 2026-03-15 (Check-in 134)

No new code. `git diff HEAD origin/main` empty. All TQs resolved. No active directives. Tests: **893 / 29 files**. _(TQ-008 one-liner authorized.)_

### Reflection — 2026-03-15 (Check-in 135)

No new code. `git diff HEAD origin/main` empty. All TQs resolved. No active directives. Tests: **893 / 29 files**. _(TQ-008 one-liner authorized.)_

### Reflection — 2026-03-15 (Check-in 136)

No new code. `git diff HEAD origin/main` empty. All TQs resolved. No active directives. Tests: **893 / 29 files**. _(TQ-008 one-liner authorized.)_

### Reflection — 2026-03-15 (Check-in 137)

No new code. `git diff HEAD origin/main` empty. All TQs resolved. No active directives. Tests: **893 / 29 files**. _(TQ-008 one-liner authorized.)_

### Reflection — 2026-03-15 (Check-in 138)

No new code. `git diff HEAD origin/main` empty. All TQs resolved. No active directives. Tests: **893 / 29 files**. _(TQ-008 one-liner authorized.)_

### Reflection — 2026-03-15 (Check-in 139)

No new code. `git diff HEAD origin/main` empty. All TQs resolved. No active directives. Tests: **893 / 29 files**. _(TQ-008 one-liner authorized.)_

### Reflection — 2026-03-15 (Check-in 140)
